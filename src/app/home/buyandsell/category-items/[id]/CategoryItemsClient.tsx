// // app/home/buyandsell/buy-sell/category/category-items/[id]/CategoryItemsClient.tsx
...
// import { Search, ChevronRight, MapPin, MoveLeft } from 'lucide-react';
...
//             selectedLocations.forEach(loc => params.append('district', loc));
...
//     return (
//         <div className="max-w-[80vw] mx-auto min-h-screen bg-gray-50">
//             {/* Breadcrumb */}
...
//                                                 if (checked) {
//                                                     setSelectedSubCats([...selectedSubCats, sub.name]);
//                                                 } else {
//                                                     setSelectedSubCats(selectedSubCats.filter((s) => s !== sub.name));
//                                                 }
//                                             }}
//                                         />
...
//                                                 className="pl-10 pr-12 h-11 rounded-full"
//                                             />
//                                             <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
//                                         </div>
//                                     </div>
//                                     <Button variant={'BlueBtn'}  >
//                                         <Link href="/home/buyandsell" className="flex justify-center items-center">
...
//                             <h1 className="text-2xl font-bold">{category.name} for Sale</h1>
//                             <p className="text-sm text-gray-600">
//                                 {loading ? 'Loading...' : `Showing ${ads.length} ads`}
//                             </p>
//                         </div>
          ...
          {filters.brands.map(brand => (
            <Label key={brand.name} className="flex items-center gap-2 text-sm cursor-pointer">
              <Checkbox
                checked={selectedBrands.includes(brand.name)}
                onCheckedChange={(c) => {
                  if (c) setSelectedBrands([...selectedBrands, brand.name]);
