// app/subcategory/[slug]/SubCategoryClient.tsx
'use client';
          ...
          <div className="max-w-7xl mx-auto px-4 py-4">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem><BreadcrumbPage>{initialData.subCategory.name}</BreadcrumbPage></BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        </div>
        ...
        <div className="md:hidden sticky top-0 z-40 bg-white border-b shadow-sm">
          <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <Sheet>
              ...
              <SheetContent side="left"><FilterSidebar filters={filters} /></SheetContent>
            </Sheet>
          </div>
        </div>
