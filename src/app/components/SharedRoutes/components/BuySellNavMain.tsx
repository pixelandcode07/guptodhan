                    ...
                    <ul className='flex gap-4 text-base'>
                        {session ? <>
                            <li className='flex flex-col justify-center items-center text-[#00005E] font-medium cursor-pointer'>
                                <Link href={'/home/UserProfile'} className='hidden md:flex flex-col justify-center items-center'>
                                    {user?.image ? (
                            ...
                            <li
                                onClick={() => signOut()}
                                className='hidden md:flex flex-col justify-center items-center text-[#00005E] font-medium cursor-pointer'><LogOut /><span className='text-[#00005E] text-[12px]'>
                                    Log out
                                </span>
                            </li>
                        </> :
