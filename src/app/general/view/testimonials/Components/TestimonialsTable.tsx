...
export default function TestimonialsTable({ initialTestimonials }: TestimonialsTableProps) {
            ...
            action: {
                ...
                onClick: async () => {
                    ...
                    try {
                        ...
                        setData(prev => prev.filter((item: Testimonial) => item._id !== id));
                    } catch (error: any) {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex gap-3">
                        <Button asChild size="icon" variant="outline" className="text-blue-500 hover:text-blue-600">
                            <Link href={`/general/add/testimonial?id=${id}`}>
                                <Pencil size={18} />
                            </Link>
                        </Button>
                        <Button
