...
export default function FlagsHeader({ onAddClick }: FlagsHeaderProps) {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-1">
              Manage and organize your product flags
            </p>
          </div>
        </div>
        ...
        <div className="flex-shrink-0 flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">Add New Flag</span>
            <span className="sm:hidden">Add Flag</span>
          </Button>
        </div>
      </div>
    </div>
