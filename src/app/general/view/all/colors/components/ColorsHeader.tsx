...
export default function ColorsHeader({ onAddClick }: ColorsHeaderProps) {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-1">
              Manage and organize your product colors
            </p>
          </div>
        </div>
        ...
        <div className="flex-shrink-0">
          ...
          >
            ...
            <span className="hidden sm:inline">Add New Color</span>
            <span className="sm:hidden">Add Color</span>
          </Button>
        </div>
      </div>
    </div>
