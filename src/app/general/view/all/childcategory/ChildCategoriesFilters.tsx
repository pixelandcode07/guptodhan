...
interface ChildCategoriesFiltersProps {
  searchText: string;
...
export default function ChildCategoriesFilters({ searchText, setSearchText, statusFilter, setStatusFilter }: ChildCategoriesFiltersProps) {
  return (
