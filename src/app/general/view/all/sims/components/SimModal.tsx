...
export default function SimModal({ open, onOpenChange, onSubmit, editing }: SimModalProps) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-lg sm:text-xl font-semibold">
            {editing ? 'Edit SIM Type' : 'Add SIM Type'}
          </DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div className="space-y-2 sm:space-y-3">
            ...
            <Input 
              ...
              placeholder="e.g., Dual SIM, Single SIM" 
              required 
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4 sm:pt-6">
            ...
            <Button 
              ...
              className="w-full sm:w-auto h-11 sm:h-auto text-sm sm:text-base"
            >
              {editing ? 'Update' : 'Create'} SIM Type
            </Button>
          </div>
        </form>
      </DialogContent>
