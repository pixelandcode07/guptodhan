...
export default function WarrantiesHeader({ onAddClick }: WarrantiesHeaderProps) {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-1">
              Manage and organize your warranty types
            </p>
          </div>
        </div>
        ...
        <div className="flex-shrink-0 flex flex-col sm:flex-row gap-2 sm:gap-3">
          ...
          >
            ...
            <span className="hidden sm:inline">Add New Warranty Type</span>
            <span className="sm:hidden">Add Warranty</span>
          </Button>
        </div>
      </div>
    </div>
