  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="bg-orange-50 border border-orange-100 p-4 rounded-xl flex items-center justify-between">
        ...
        <Link href={'/general/view/vendor/requests'} className="text-xs bg-white border border-orange-200 text-orange-600 px-3 py-1.5 rounded-md hover:bg-orange-100 transition">
          Review
        </Link>
