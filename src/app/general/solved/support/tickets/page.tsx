...
async function getData(): Promise<SupportTicketRow[]> {
    return [
        { id: '1', sl: 1, ticketNo: 'T-2001', customer: 'Sifat Hossain', subject: 'ticket number 309', attachment: 'No Attachment Found', status: 'Solved' },
    ]
}

export default async function SolvedSupportTicketsPage() {
