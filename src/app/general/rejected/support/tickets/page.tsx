...
async function getData(): Promise<SupportTicketRow[]> {
    return [
        { id: '1', sl: 1, ticketNo: '1738686419', customer: 'Md Ibrahim', subject: 'Payment Issue : Hello sir', attachment: 'No Attachment Found', status: 'Rejected' },
    ]
}

export default async function RejectedSupportTicketsPage() {
