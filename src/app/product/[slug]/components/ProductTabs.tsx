            ...
            <TabsList className="w-full h-auto bg-transparent p-0 flex justify-start sm:justify-center min-w-max">
              {tabs.map((tab) => (
                <TabsTrigger
                  ...
                  value={tab.id}
                  className="
                    px-6 py-3.5 rounded-none border-none text-sm font-semibold transition-colors flex-1
          ...
          <div className="p-6 sm:p-8 min-h-[300px] bg-white">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* 1. Description Tab */}
                <TabsContent value="description" className="m-0 focus-visible:outline-none w-full">
                  <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Description</h2>
                  {product.fullDescription ? (
                    <article 
                      className="
                        prose prose-slate max-w-none w-full text-gray-700 leading-7
                    ...
                    <div className="w-full border border-gray-200 rounded-md">
                      <div 
                        className="
                          ...
                          [&_td:first-child]:bg-[#EFF1F5] [&_td:first-child]:text-[#666666] [&_td:first-child]:font-semibold [&_td:first-child]:w-[25%] [&_td:first-child]:min-w-[150px] [&_td:first-child]:border-r [&_td:first-child]:border-gray-200
                          [&_td:last-child]:bg-white [&_td:last-child]:text-[#111111]
                          [&_tr:hover_td:last-child]:bg-[#f9fafb]
                          [&_td[colspan]]:bg-[#F4F6FC] [&_td[colspan]]:text-[#00005E] [&_td[colspan]]:font-bold [&_td[colspan]]:text-[15px] [&_td[colspan]]:py-2.5 [&_td[colspan]]:border-b
                        "
                ...
                {/* 3. Questions Tab */}
                <TabsContent value="qna" className="m-0 focus-visible:outline-none w-full">
                  <div className="mb-6">
                ...
                {/* 4. Reviews Tab */}
                <TabsContent value="reviews" className="m-0 focus-visible:outline-none w-full">
                  <div className="mb-6">
