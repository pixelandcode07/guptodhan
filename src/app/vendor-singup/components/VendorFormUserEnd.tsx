                  ...
                  {step === 1 && (
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input {...register("business_name", { required: true })} placeholder="Example: XYZ enterprise" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <Input {...register("trade_license_number")} placeholder="Valid Trade License Number." />
                      </div>
                      <div>
                        <Label className="text-emerald-600 font-semibold pb-2">Business Address</Label>
                        <Input {...register("business_address")} placeholder="Example: 123 Main Street, City, Country" />
                      </div>
                    </div>
                  )}
