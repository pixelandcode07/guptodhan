...
export type TotalWithdrawalInfo = {
  type: "Completed" | "Pending" | "Cancelled" | "Vendor",
  title: string,
  amount: number,
}


export type AllWithdrawalData = {
  serial: string,
  vendor_name: string,
  amount: number,
  date_time: string,
...
export const allWithdrawal: ColumnDef<AllWithdrawalData>[] = [
  {
    accessorKey: "serial",
    header: "Serial",
  },
